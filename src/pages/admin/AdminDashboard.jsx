...
import { fetchStats, fetchPayments, fetchuser } from "../../redux/actions/adminDashboardActions";
  ...
  return (
    <div className="flex">
      <div
        className={`fixed fixed inset-0 z-50 h-full transition-transform transform bg-white md:relative md:translate-x-0 md:bg-transparent flex flex-col transition-transform transform ${
