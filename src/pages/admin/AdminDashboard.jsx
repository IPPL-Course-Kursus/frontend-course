...
const AdminDashboard = () => {
  ...
  const filteredPayments = paymentStatus.filter((payment) => {
    const isGlobalSearchMatch =
      globalSearch === "" ||
      payment.id && payment.id.toString().includes(globalSearch.toLowerCase()) ||  
      ...
      <div className="flex-1 flex flex-col p-4 md:p-6 bg-secondary min-h-screen">
        ...
        <div className="overflow-x-auto bg-white p-4 mt-2">
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <button
              className={`flex items-center py-2 px-4 rounded-lg ${currentPage === totalPages ? "bg-gray-300 cursor-not-allowed" : "bg-[#0a61aa] text-white"} transition-all duration-300 hover:scale-105`}
