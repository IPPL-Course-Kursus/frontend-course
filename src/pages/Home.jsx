                    ...
                    <div className="flex flex-col">
                        <div>
                            <h1 className="font-semibold text-white sm:text-xl lg:text-3xl">
                                ...
                                Jadilah Talenta Digital Handal <br /> Praktisi
                                Terbaik!
                            </h1>
                ...
                <div className="flex flex-col lg:flex-row items-center max-w-6xl px-6 lg:px-12">
                    ...
                    <div className="lg:w-1/2 text-center lg:text-left mt-6 lg:mt-0 lg:pl-12">
                        ...
                        <p className="text-white text-base mb-6">
                            Kuasai strategi menjadi freelancer profesional untuk
                            meningkatkan pendapatan secara langsung bersama para
                            ahli berpengalaman.
                        </p>
                    ...
                    <div className="flex flex-col  items-center lg:flex-row lg:items-center">
                        ...
                        <div className="flex flex-col  items-center lg:justify-end lg:w-1/2 ">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 ml-10 pb-10 lg:pb-0">Mahasiswa</p>
                            </div>
                        </div>
                            <div className="relative mt-10 lg:absolute -right-0 lg:-right-6 w-12 h-12 bg-neutral rounded-full hidden lg:block ">
