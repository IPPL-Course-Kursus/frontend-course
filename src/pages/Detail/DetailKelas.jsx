                ...
                <div className="flex items-center bg-grey p-4 rounded-md">
                  ...
                  <div>
                    <p className="font-medium text-[#151515] text-lg leading-5">
                      {`${detail.promoStatus ? detail.courseDiscountPrice : detail.coursePrice}`}{" "}
                    </p>
                  </div>
                </div>
              </div>
              ...
              {detail.chapters?.length > 0 ? (
                detail.chapters.map((chapter) => (
                  <div key={chapter.id} className="mb-3">
                    ...
                    >
                      <span className="font-semibold text-gray-700">{chapter.chapterTitle}</span>
                    ...
                    {expandedChapter === chapter.id && (
                      <div className="mt-2 pl-4 bg-blue-50 rounded-lg py-2">
                        {chapter.contents?.length > 0 ? (
                          ...
                          <p className="text-gray-500 pl-2">Tidak ada konten tersedia</p>
                        )}
                      </div>
                    )}
                  </div>
