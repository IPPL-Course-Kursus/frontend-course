...
const KategoriForm = ({
  ...
  imagePreview,
  handleImageUpload,
  isSubmitDisabled, // Controls button disabled state due to validation
  isSubmitting,     // Controls button label and disabled state during submission
}) => {
  if (!show) return null;
...
KategoriForm.propTypes = {
  ...
  handleImageUpload: PropTypes.func.isRequired,
  isSubmitDisabled: PropTypes.bool, // New prop type
  isSubmitting: PropTypes.bool,     // New prop type
};
