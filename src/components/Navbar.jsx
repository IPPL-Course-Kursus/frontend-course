...
// import { FiBookOpen, FiLayers, FiLogOut, FiMenu, FiChevronDown } from "react-icons/fi";
...
//                     className="flex items-center py-3 px-4 font-medium text-gray-700 hover:bg-gradient-to-r hover:from-primary hover:to-red-600 hover:text-white rounded-lg transition-all duration-300 ease-in-out w-full"
//                   >
//                     <FiLogOut className="h-6 w-6 mr-3 text-red-600" />
//                     Logout
//                   </button>
//                 </li>
//               </ul>
...
//           <Link
//             to="/login"
//             className="btn btn-primary rounded-lg hover:bg-red-600 transition-all duration-300 ease-in-out"
//           >
//             Masuk
//           </Link>
//         )}
