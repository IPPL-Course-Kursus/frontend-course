...
const CardRecomendation = ({ title = "Kelas Rekomendasi" }) => {
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="mx-2 md:mx-4 flex flex-col mt-1 md:mt-2">
                      ...
                      <div className="my-2">
                        <Link
                          to="/detail-kelas"
                          className="py-1 px-9 bg-black  text-white font-semibold rounded-full text-xs transition-all duration-300 hover:scale-105"
                        >
                          Beli
                        </Link>
                      </div>
