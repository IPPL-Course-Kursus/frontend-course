...
//   return (
//     <>
//       <div className="flex justify-center bg-[#EBF3FC] py-10 mt-20">
...
//                     <div className="flex flex-col items-center p-3 bg-white shadow-md rounded-lg hover:shadow-xl transition-shadow duration-300">
//                       <img
//                         src={kategori.img}
//                         alt={kategori.title}
