...
//       {/* Card Course Section */}
//       <div className="max-w-screen-lg mx-auto px-6 lg:p-0">
//         {filteredCoursePopular.length > 0 ? (
...
//     infinite: true,
//     speed: 500,
//     slidesToShow: filteredCoursePopular.length > 1 ? 3 : 1, // Menampilkan 1 item jika hanya ada 1
//     slidesToScroll: 1,
//     nextArrow: <NextArrow />,
//     prevArrow: <PrevArrow />,
//     responsive: [
...
//         breakpoint: 1024,
//         settings: {
//           slidesToShow: filteredCoursePopular.length > 2 ? 2 : 1,
//           slidesToScroll: 1,
//         },
//       },
//       {
