...
const DataKelasInput = ({ show, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (duplicateCourse) {
      setCourseNameError("Judul kelas sudah ada dalam kategori ini.");
      setError("Judul kelas sudah ada dalam kategori ini.");
      toast.error("Judul kelas sudah ada dalam kategori ini."); // Notifikasi error dalam Bahasa Indonesia
      return;
    }
