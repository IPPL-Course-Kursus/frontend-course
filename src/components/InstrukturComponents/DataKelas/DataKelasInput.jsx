...
const DataKelasInput = ({ show, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSend.append("typeCourseId", formData.typeCourseId);
    formDataToSend.append("courseLevelId", formData.levelCourseId);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleInputChange}
              className="w-full p-2 border rounded-xl"
              placeholder="Masukkan target audiens"
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              onChange={handleInputChange}
              className="w-full p-2 border rounded-xl"
              placeholder="Masukkan deskripsi tentang kelas"
            />
          </div>
