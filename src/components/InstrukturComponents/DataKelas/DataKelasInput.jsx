...
//   //   e.preventDefault();
//   //   dispatch(addDataKelas(requestData, imageFile));
//   //   onClose();
//   // };
//   // const handleSubmit = (e) => {
//   //   e.preventDefault();
//   //   // Dispatch action untuk menambah data kelas
//   //   dispatch(addDataKelas(requestData, imageFile)).then((response) => {
//   //     if (response && response.data) {
//   //       addDataKelas(response.data); // Panggil fungsi untuk menambahkan kelas baru
//   //     }
//   //     onClose(); // Tutup form setelah menambahkan kelas
//   //   });
//   // };
//   const handleSubmit = (e) => {
//     e.preventDefault();
...
//         dispatch(fetchUserCourses()); // Misalkan Anda memiliki action untuk fetching
//       }
//       onClose(); // Tutup form setelah menambahkan kelas
//     });
//   };
