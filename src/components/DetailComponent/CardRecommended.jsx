...
import CardSkeleton from "../Skeleton/CardSkeletonRecommend";
      ...
      <div className="flex flex-col items-center container gap-5 pt-[26px] pb-[53px]">
        ...
        <div className="grid mt-2 gap-2 grid-cols-1 w-full md:grid-cols-2 md:gap-6 lg:grid-cols-3 lg:mt-4">
          {recommendedCourses.length > 0 ? (
            ...
            <div className="grid mt-2 gap-2 grid-cols-1 w-full md:grid-cols-2 md:gap-72 lg:gap-64 xl:gap-96 lg:grid-cols-3 lg:mt-4">
  {[...Array(3)].map((_, index) => (
