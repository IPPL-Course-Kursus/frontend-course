...
const SidebarInstruktur = () => {
  ...
  return (
    <div className="flex h-full min-h-screen">
      <div className="w-64 bg-blue-900 text-white fixed left-0 top-0 bottom-0 flex flex-col">
      ...
      <div className="flex-1 ml-64 p-4">{/* Konten dashboard atau halaman lain di sini */}</div>
    </div>
  );
};
